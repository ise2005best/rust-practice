pub fn assignment() {
    ...
    impl PartialOrd for Triangle{
        ...
        // they all return boolean values, true if the comparison is right and false if the comparison is false
        // compare areas of triangle with one another using the >=
        fn ge(&self, other: &Self) -> bool {
            self.area_of_triangle() == other.area_of_triangle()
        }
        // compare two different bases using the >
        fn gt(&self, other: &Self) -> bool {
            self.base == other.base
        }
        // compare side1 of two different bases using the <=
        fn le(&self, other: &Self) -> bool {
            self.side1 == other.side1
        }
        // compare side2 of two different bases using the <
    ...
    println!("Is triangle1 area greater than or equals to triangle2 area {}", triangle1.area_of_triangle().ge(&triangle2.area_of_triangle()));
    println!("Is the base of triangle1 greater than the base of triangle2 {}", triangle1.base.ge(&triangle2.base))
